...
public interface RecordRepository extends JpaRepository<Record, Long> {
	...
	public final static String QUERY_ALL_BY_RECORD_TYPE_RUN_TYPE = "SELECT u FROM Record u where u.recordType=:recordType AND u.runType=:runType ORDER BY u.id ASC";
